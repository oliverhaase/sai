...
object InstructionInterpreter {
  ...
  private def lookupInterpreter(
      instruction: org.apache.bcel.generic.Instruction): InstructionInterpreter =
    instruction match {
      ...
      case i: org.apache.bcel.generic.CHECKCAST         => CheckcastInterpreter(i)
      ...
      case i: org.apache.bcel.generic.InvokeInstruction => InvokeInterpreter(i)
      case i: org.apache.bcel.generic.LDC               => LdcInterpreter(i)
